...
class BackendIssueProgressTests(APITestCase):
    ...
    def test_admin_contract_endpoints_include_frontend_friendly_aliases(self):
        ...
        self.assertIn("customer", detail_response.data)
        ...
        self.assertEqual(detail_response.data["customer"]["todayRecommendationName"], selected_row.style_name_snapshot)
    ...
    def test_admin_recommendation_and_style_reports_match_frontend_mock_structure(self):
        ...
        self.assertIn("hairstyles", recommendation_response.data)
        self.assertIn("customer", recommendation_response.data)
        ...
        self.assertEqual(recommendation_response.data["customer"]["todayRecommendationId"], selected_row.style_id_snapshot)
        ...
        self.assertEqual(recommendation_response.data["hairstyles"][0]["id"], selected_row.style_id_snapshot)
